...
class KLO_kuisioner_result extends CI_Controller {
	public function __construct()
  {
    parent::__construct();
    $this->load->model('MKLO_Kuisioner_Result');
    ...
    $data['kode'] 					= $this->MKLO_Kuisioner_Result->get_no_kuisioner();
  ...
  //   }
    ...
    {
       $insert = $this->MKLO_Kuisioner_Result->tambah();
    ...
    {
        $data = $this->MKLO_Kuisioner_Result->edit_by_id($id); // get data dari database melalui model
    ...
    public function update()
    {
        ...
        $this->MKLO_Kuisioner_Result->update($id, $data);
        echo json_encode(array("status" => TRUE));
    }

    public function destroy($id)
    {
        $data = $this->MKLO_Kuisioner_Result->edit_by_id($id); // get id dari database melalui model
        $this->MKLO_Kuisioner_Result->delete_by_id($id);
        echo json_encode(array("status" => TRUE));
    }
