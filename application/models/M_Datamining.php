...
class M_Datamining extends CI_Model{
    ...
    var $column_order = array(null, 'id_datamining','id_atribut','jml_jawaban','entrophy','gain'); //field yang ada di table kuisioner
    var $table = 't_atribut';
    ...
    {
        $this->db->insert('t_datamining', $data);
