      ...
      <div class="card">
        <div class="card-body">
          <div class="bs-example" data-example-id="simple-jumbotron">
              <div class="jumbotron">
                  <ul><li>IF <span style="color:#1abb9c;">NV</span> = NORMAL </li><ul><li>IF <span style="color:#1abb9c;">PP</span> = SUPERIOR</li>&nbsp;&nbsp;&nbsp; return IPA<br><li>IF <span style="color:#1abb9c;">PP</span> = NORMAL</li>&nbsp;&nbsp;&nbsp; return IPS<br><li>IF <span style="color:#1abb9c;">PP</span> = TINGGI </li><ul><li>IF <span style="color:#1abb9c;">DK</span> = NORMAL </li><ul><li>IF <span style="color:#1abb9c;">PU</span> = NORMAL </li><ul><li>IF <span style="color:#1abb9c;">PB</span> = NORMAL </li><ul><li>IF <span style="color:#1abb9c;">I</span> = NORMAL </li><ul></ul></ul></ul></ul><li>IF <span style="color:#1abb9c;">DK</span> = TINGGI</li>&nbsp;&nbsp;&nbsp; return IPS<br></ul></ul><li>IF <span style="color:#1abb9c;">NV</span> = TINGGI</li>&nbsp;&nbsp;&nbsp; return IPA<br></ul>
              </div>
          </div>
        </div>
      </div>
