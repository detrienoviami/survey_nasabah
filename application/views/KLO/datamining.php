      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="table table-responsive">
            <div class="x_title">
              <!-- <h2>Pembuatan Pohon Keputusan (C45)<small></small></h2> -->
...
table = $('#show_table').DataTable({
    ...
    "ajax": {
        "url": "<?php echo site_url('KLO_datamining/datatables')?>",
        "type": "POST"
    },
...
function ajax_save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('KLO_datamining/tambah')?>"; // url untuk tambah data
    } else {
        url = "<?php echo site_url('KLO_datamining/update')?>"; // url untuk update data
    }
...
function ajax_edit(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('KLO_datamining/edit')?>/" + id, // ini url edit data untuk meload data dari database(controller) ke view
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
    ...
    iziToast.question({
        ...
        buttons: [
            ['<button><b>Hapus</b></button>', function (instance, toast) {
                $.ajax({
                    url : "<?php echo site_url('KLO_datamining/destroy')?>/"+id, // url untuk menghapus data dari controller
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
